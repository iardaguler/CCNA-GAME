...
class Level3:
    def __init__(self, screen):
        ...
        self.task_title = "MISSION: IP ADDRESSING"
    ...
    def process_command(self, cmd):
        ...
        if self.current_mode == 1:
            if cmd in ["configure terminal", "conf t"]:
                ...
                self.feedback = "ERROR: Type 'conf t' to configure."

        elif self.current_mode == 2:
            if cmd.startswith("interface ") or cmd.startswith("int "):
                if "g0/0" in cmd or "gig0/0" in cmd or "gigabitethernet0/0" in cmd:
                    self.current_mode = 3
            ...
            if cmd.startswith("ip address "):
                ...
                if len(parts) >= 4:
                    ...
                    self.feedback = "ERROR: Incomplete command."

            elif cmd in ["no shutdown", "no shut"]:
                self.port_up = True
                ...
                self.feedback = "ERROR: Try 'ip address ...' or 'no shutdown'."
    ...
    def draw_top_bar(self):
        ...
        status_text = "STATUS: ACTIVE" if not self.completed else "STATUS: MISSION COMPLETE"
    ...
    def draw_victory_popup(self):
        ...
        t2 = self.font_header.render("INTERFACE CONFIGURATION SAVED", True, WHITE)
